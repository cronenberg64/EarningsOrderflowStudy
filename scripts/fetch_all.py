...
def main():
    ...
    if not os.path.exists('data/lm_dict.csv'):
        ...
        try:
            ...
            print(f"Failed to download LM dictionary ({e}). Generating minimal baseline...")
            create_minimal_dict('data/lm_dict.csv')

def create_minimal_dict(out_path):
    import pandas as pd
    data = [
        ['PROFIT', 0, 2026, 0, 0, 0, 0], ['LOSS', 2026, 0, 0, 0, 0, 0],
        ['GROWTH', 0, 2026, 0, 0, 0, 0], ['DECLINE', 2026, 0, 0, 0, 0, 0],
        ['SUCCESS', 0, 2026, 0, 0, 0, 0], ['FAILURE', 2026, 0, 0, 0, 0, 0],
        ['UNCERTAIN', 0, 0, 2026, 0, 0, 0], ['RISK', 0, 0, 2026, 0, 0, 0],
        ['LAWSUIT', 0, 0, 0, 2026, 0, 0], ['LITIGATION', 0, 0, 0, 2026, 0, 0],
        ['MUST', 0, 0, 0, 0, 2026, 0], ['ALWAYS', 0, 0, 0, 0, 2026, 0],
        ['MAY', 0, 0, 0, 0, 0, 2026], ['COULD', 0, 0, 0, 0, 0, 2026],
        ['BEAT', 0, 2026, 0, 0, 0, 0], ['MISS', 2026, 0, 0, 0, 0, 0],
        ['ABOVE', 0, 2026, 0, 0, 0, 0], ['BELOW', 2026, 0, 0, 0, 0, 0]
    ]
